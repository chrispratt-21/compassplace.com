    ...
    <footer class="cp-footer">
      <div class="cp-footer-wrap">
        ...
        <div class="cp-footer-social" aria-label="Social media links">
          ...
          <a href="https://www.youtube.com/@compassplace" target="_blank" rel="noopener noreferrer" aria-label="Compass Place on YouTube" title="YouTube">
            <svg viewBox="0 0 24 24" aria-hidden="true"><rect x="2" y="5" width="20" height="14" rx="4"/><polygon points="10,9 16,12 10,15" fill="currentColor" stroke="none"/></svg>
          </a>
